...
<head>
    ...
    <title>لوحة تحكم الطالب - مدرستي نور</title>
...
<body class="text-gray-900 bg-gray-50">
        ...
        <nav class="container mx-auto px-4 sm:px-6 py-3">
            <div class="flex justify-between items-center">
                ...
                <a href="index.html" class="flex items-center space-x-2 space-x-reverse">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-600 to-green-700 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-white" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z" />
                        </svg>
                    </div>
                    <span class="text-xl font-black text-green-900">مدرستي نور</span>
                </a>

                <!-- Desktop Navigation -->
                <div class="hidden md:flex items-center space-x-8 space-x-reverse">
                    <a href="index.html" class="font-semibold text-gray-700 hover:text-green-600 transition-colors relative group">
                        الرئيسية
                        <span class="absolute bottom-0 right-0 w-0 h-0.5 bg-green-600 transition-all group-hover:w-full"></span>
                    </a>
                    <a href="team.html" class="font-semibold text-gray-700 hover:text-green-600 transition-colors relative group">
                        الدروس
                        <span class="absolute bottom-0 right-0 w-0 h-0.5 bg-green-600 transition-all group-hover:w-full"></span>
                    </a>
                    <a href="about.html" class="font-semibold text-gray-700 hover:text-green-600 transition-colors relative group">
                        تقدمي
                        <span class="absolute bottom-0 right-0 w-0 h-0.5 bg-green-600 transition-all group-hover:w-full"></span>
                    </a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-4 space-x-reverse">
                    <a href="#" class="font-semibold text-gray-700 hover:text-green-600 transition-colors">تسجيل الدخول</a>
    ...
    <main class="flex flex-col lg:flex-row-reverse min-h-screen">
        ...
        <div id="sidebar" class="w-full lg:w-72 bg-gray-800 p-4 lg:p-6 shadow-xl sidebar-wrapper overflow-y-auto">
            ...
            <div class="relative flex flex-row-reverse justify-between items-center px-3 py-4 mb-6 pb-4 border-b border-gray-700">
                ...
                <div class="flex items-center">
                    <div class="ml-3 relative">
                        <div class="rounded-full w-12 h-12 bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center shadow-md">
                    ...
                    <div class="text-right">
                        <p class="text-white font-medium">أحمد الطالب</p>
                        <p class="text-gray-400 text-sm">الأولى إعدادي - علمي</p>
                    </div>
                </div>
                ...
                <div id="student-info-popover" class="absolute bg-gray-700 text-white p-4 rounded-xl shadow-lg z-50 w-72
                    ...
                    <div class="space-y-3 text-right">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-gray-100">أحمد الطالب</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="font-semibold text-gray-300">البريد الإلكتروني:</span>
                            <span class="text-gray-400 text-xs truncate max-w-[120px]">ahmed.student@example.com</span>
                        </div>
                        <div class="flex justify-between items-center">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="font-semibold text-gray-300">المستوى:</span>
                            <span class="text-yellow-400 font-medium">الأولى إعدادي</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="font-semibold text-gray-300">المعدل:</span>
                            <span class="text-green-400 font-medium">87%</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="font-semibold text-gray-300">المهارات:</span>
            ...
            <!-- Dashboard Title -->
            <h3 class="text-lg font-medium text-gray-300 mb-6 text-right px-3">لوحة تحكم الطالب</h3>
            ...
            <ul class="space-y-2">
                <li>
                    <a href="#" class="sidebar-toggle-btn flex flex-row-reverse items-center justify-between w-full py-3 px-4 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-all-custom focus-ring group">
                        <div class="flex items-center space-x-3 space-x-reverse">
                            <div class="w-8 h-8 rounded-lg bg-emerald-900/20 flex items-center justify-center">
                ...
                <li>
                    <button class="sidebar-toggle-btn flex items-center justify-between w-full py-3 px-4 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-all-custom focus-ring group">
                        ...
                        <div class="flex items-center space-x-3 space-x-reverse">
                            ...
                            <span class="text-base font-medium">الدروس</span>
                        </div>
                    </button>
                    <ul class="sidebar-submenu hidden space-y-1 pt-2 pl-8 border-r-2 border-blue-500 mr-4">
                        <li>
                            <a href="{{route('student.lesson.index')}}" class="block py-2 px-4 rounded-md text-gray-400 hover:bg-gray-700 hover:text-white transition-colors text-right text-sm font-normal group">
                                <span class="relative">
                                    جميع الدروس
                ...
                <!-- التقدم والمهارات -->
                <li>
                    <a href="{{route('student.interaction_notes.index')}}" class="sidebar-toggle-btn flex flex-row-reverse items-center justify-between w-full py-3 px-4 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-all-custom focus-ring group">
                        <div class="flex items-center space-x-3 space-x-reverse">
                            ...
                            <span class="text-base font-medium">ملاحظات المعلم</span>
                        </div>
                    </a>
                </li>
                <!-- الامتحانات -->
                <li>
                    <button class="sidebar-toggle-btn flex items-center justify-between w-full py-3 px-4 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-all-custom focus-ring group">
                        ...
                        <div class="flex items-center space-x-3 space-x-reverse">
                            ...
                            <span class="text-base font-medium">الامتحانات</span>
                        </div>
                    </button>
                    <ul class="sidebar-submenu hidden space-y-1 pt-2 pl-8 border-r-2 border-purple-500 mr-4">
                        ...
                        <li>
                            <a href="{{ route('student.exam_weekly_reports.index') }}" class="block py-2 px-4 rounded-md text-gray-400 hover:bg-gray-700 hover:text-white transition-colors text-right text-sm font-normal group">
                                <span class="relative">
                                    النتائج
                                    <span class="absolute right-0 top-1/2 transform -translate-y-1/2 w-1 h-1 bg-purple-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span>
                                </span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-right">
                <div>
                    <h3 class="text-xl font-black text-white flex items-center justify-end">
                        <div class="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-600 to-green-700 flex items-center justify-center ml-2">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2">
                        ...
                        <li><a href="team.html" class="text-gray-400 hover:text-white text-sm transition-colors">الدروس</a></li>
                        <li><a href="about.html" class="text-gray-400 hover:text-white text-sm transition-colors">تقدمي</a></li>
