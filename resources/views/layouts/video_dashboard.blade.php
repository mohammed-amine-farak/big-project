    ...
    <main class="flex flex-col lg:flex-row-reverse min-h-screen">
        ...
        <div id="sidebar" class="w-full lg:w-72 bg-gray-800 p-4 lg:p-6 shadow-xl sidebar-wrapper overflow-y-auto">
            ...
            <ul class="space-y-2">
                ...
                <!-- ===================== -->
                <li>
                    <a href="{{route('video_creator.dashboard')}}" class="sidebar-toggle-btn flex flex-row-reverse items-center justify-between w-full py-3 px-4 rounded-lg text-gray-300 hover:bg-gray-700 hover:text-white transition-all-custom focus-ring group">
